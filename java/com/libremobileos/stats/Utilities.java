...
public class Utilities {
    ...
    public static String getDevice() {
        return SystemProperties.get("ro.lmodroid.device", Build.PRODUCT);
    }

    public static String getModVersion() {
        String modVersion = SystemProperties.get("ro.lmodroid.build_name", Build.DISPLAY);
        return modVersion.replaceFirst("^LMODroid-", "");
    }
    ...
    public static boolean isStatsCollectionEnabled(Context context) {
        return Settings.Secure.getInt(context.getContentResolver(),
                LMOSettings.Secure.STATS_COLLECTION, 1) != 0;
    }
    ...
    public static void setStatsCollectionEnabled(Context context, boolean enabled) {
        ...
        Settings.Secure.putInt(context.getContentResolver(),
                LMOSettings.Secure.STATS_COLLECTION, enable);
    }
