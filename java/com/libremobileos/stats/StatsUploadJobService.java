...
public class StatsUploadJobService extends JobService {
    ...
    public static final int JOB_TYPE_LIBREMOBILEOSCOM = 1;
    ...
    private boolean uploadToLibremobileos(JSONObject json) throws IOException {
        final Uri uri = Uri.parse(getString(R.string.stats_libremobileos_url));
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, "libremobileos server response code=" + responseCode);
